...
export const alkesDokumen = [
    { nama_alkes: "Hematologi Analyzer", standard: "1" },
    { nama_alkes: "Chemistry Analyzer", standard: "1" },
    { nama_alkes: "Mikroskop Binokuler", standard: "1" },
    ...
    { nama_alkes: "Suction Pump Portable", standard: "2 (non rawat inap), 3 (rawat inap)" },
    { nama_alkes: "Kursi Gigi", standard: "1" },
    { nama_alkes: "Elektrokardiograf", standard: "1" },
    { nama_alkes: "Infant Radiant Warmer", standard: "1" },
    { nama_alkes: "Pompa Infus", standard: "1" },
    { nama_alkes: "Infant T Piece Resuscitator dengan Katup Peep", standard: "1" },
    { nama_alkes: "Electrocauter", standard: "1" },
    { nama_alkes: "Tabung Oksigen 6 Meterkubik", standard: "2 (non rawat inap), 3 (rawat inap)" },
    { nama_alkes: "Brankar", standard: "1" },
    { nama_alkes: "Spirometer", standard: "1" },
    { nama_alkes: "Optalmoskop", standard: "1" },
    { nama_alkes: "Otoskop", standard: "1" },
    { nama_alkes: "Garputala Set", standard: "1" },
    { nama_alkes: "Sanitarian Kit", standard: "1" },
    { nama_alkes: "CO Analyzer", standard: "2" },
    { nama_alkes: "Spray Can", standard: "1" },
    { nama_alkes: "Thermal Ablation", standard: "1" },
    { nama_alkes: "Kursi Roda Standar", standard: "2" },
    { nama_alkes: "Laringoskop", standard: "1" },
    { nama_alkes: "Tempat Tidur Manual Persalinan", standard: "3" },
    { nama_alkes: "Nebulizer", standard: "1 (non rawat inap), 2 (rawat inap)" },
    { nama_alkes: "Tempat Tidur Manual", standard: "2 (non rawat inap), 6 (rawat inap)" },
    { nama_alkes: "Tiang Infus Standar", standard: "6 (non rawat inap), 10 (rawat inap)" },
    { nama_alkes: "Boks Bayi", standard: "2" },
    { nama_alkes: "Autoklaf", standard: "1" },
    { nama_alkes: "Meja Instrumen", standard: "10 (non rawat inap), 11 (rawat inap)" },
    { nama_alkes: "Lampu periksa dengan baterai", standard: "2 (non rawat inap), 3 (rawat inap)" },
    { nama_alkes: "Kursi Gigi Lapangan", standard: "1 (non rawat inap)" },
    { nama_alkes: "Doppler", standard: "2" },
    { nama_alkes: "Tabung Oksigen 1 Meterkubik", standard: "3" },
    { nama_alkes: "DC Shock", standard: "1" },
    { nama_alkes: "Tonometer Non Kontak", standard: "1" },
