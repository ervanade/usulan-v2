...
const Login = () => {
  ...
  return (
    <div className="w-full !dark:bg-boxdark-2 flex justify-center items-center min-h-[calc(100vh-0px)] bg-transparent object-cover bg-center py-6 bg-gradient-to-r from-emerald-600 to-teal-500">
      <div className="w-full max-w-lg bg-[#edfdf8] shadow-md rounded-md  pt-8 pb-12 mb-4 mx-6">
        ...
        rounded w-full py-3 px-3 text-[#475569] mb-3 leading-tight focus:outline-none focus:shadow-outline`}
            ...
            <div className="flex items-center justify-center mt-6">
              <button
                className="w-full bg-gradient-to-r from-emerald-600 to-teal-500  text-white font-bold py-4 px-6 rounded focus:outline-none focus:shadow-outline"
                type="submit"
                disabled={loading}
              >
